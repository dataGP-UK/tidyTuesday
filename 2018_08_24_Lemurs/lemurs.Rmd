...
# CMED in one set CMEAD in the other --> NA when left join
taxonomy$taxon <- 
  taxonomy$taxon %>% 
...
Group_together data for each individual lemur and exclude hybrids.

There are 2 different hybrid species both coded as 'hybrid' so they are joined together when grouping by 'common' name.
...
Choose top pure species

```{r}
top_species <- lemurs_species %>%  
